...
import { Users, Clock, Zap, ShieldCheck, Sparkles, Building2, Flame } from 'lucide-react';
...
export const OurStorySection = () => {
  return (
    <section className="py-16 bg-[#121417] relative overflow-hidden border-b border-[#23272B]">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#E8590C]/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* 3 Architectural Feature Showcase Cards */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {AMBIENCE_HIGHLIGHTS.map((item, idx) => (
            <div
              key={item.id}

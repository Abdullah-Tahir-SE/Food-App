        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-8">
            ...
            >
              ...
              <div className="relative flex items-center justify-center w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#E8590C] to-[#D9480F] shadow-[0_0_20px_rgba(232,89,12,0.5)] group-hover:scale-105 transition-transform duration-300">
                <UtensilsCrossed className="w-5 h-5 sm:w-6 sm:h-6 text-white transform group-hover:rotate-12 transition-transform duration-300" />
                <div className="absolute -bottom-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-[#FF922B] rounded-full border-2 border-[#121417] flex items-center justify-center">
                  <span className="block w-1 h-1 sm:w-1.5 sm:h-1.5 bg-white rounded-full animate-ping" />
                </div>
              </div>

              <div className="text-left">
                <span className="font-display font-black text-xl sm:text-3xl tracking-tighter text-white uppercase block leading-none">
                  FOOD <span className="text-[#E8590C]">CART</span>
                </span>
                <span className="text-[8px] sm:text-[10px] tracking-widest text-amber-400 font-bold uppercase block mt-0.5 sm:mt-1">
                  CRUNCH & DELIGHT
                </span>
              </div>
            </button>
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-3">
            ...
            {user ? (
              ...
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-1.5 sm:space-x-2 bg-[#181B1E] hover:bg-[#23272B] border border-[#23272B] hover:border-[#E8590C]/50 px-2 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs font-bold text-white transition-all cursor-pointer shadow-md"
                >
              ...
              <button
                ...
                className="flex items-center space-x-1 sm:space-x-2 bg-[#181B1E] hover:bg-[#23272B] border border-[#23272B] hover:border-[#E8590C]/60 text-white px-2 sm:px-4 py-2 sm:py-2.5 rounded-xl font-extrabold text-[10px] sm:text-xs uppercase tracking-wider transition-all cursor-pointer shadow-md"
              >
                <User className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FF922B]" />
            ...
            {activeTab === 'admin' ? (
              ...
              <button
                ...
                className="relative flex items-center space-x-1.5 sm:space-x-2.5 bg-gradient-to-r from-[#E8590C] to-[#D9480F] hover:from-[#D9480F] hover:to-[#E8590C] text-white px-2.5 sm:px-5 py-2 sm:py-2.5 rounded-xl font-extrabold text-[10px] sm:text-xs shadow-lg shadow-[#E8590C]/30 hover:scale-105 transition-all duration-200 focus:outline-none cursor-pointer"
              >
